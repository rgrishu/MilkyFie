...
$(window).on('scroll', function () {
    if ($(window).scrollTop() > 70) { // Set position from top to add class
        ...
        $('.navbar .navbar-brand> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.green_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.pink_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.orange_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.orange_logo_rtl> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.yellow_logo_crypto> img').attr('src', 'siteadmin/images/logo.png');
        $('.navbar .navbar-brand.yellow_logo> img').attr('src', 'siteadmin/images/logo.png');

        $('.index-light .navbar .navbar-brand> img').attr('src', 'siteadmin/images/logo.png');
        $('.index-light .navbar .navbar-brand.green_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.index-light .navbar .navbar-brand.yellow_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.index-light .navbar .navbar-brand.pink_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', 'siteadmin/images/logo.png');

        $('.active-navbar .navbar .navbar-brand> img').attr('src', 'siteadmin/images/logo.png');
        $('.active-navbar .navbar .navbar-brand.green_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.active-navbar .navbar .navbar-brand.pink_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.active-navbar .navbar .navbar-brand.orange_logo> img').attr('src', 'siteadmin/images/logo.png');
        $('.active-navbar .navbar .navbar-brand.yellow_logo> img').attr('src', 'siteadmin/images/logo.png');
